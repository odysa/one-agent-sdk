...
**One SDK for every coding agent.** A provider-agnostic TypeScript SDK for building LLM agents with type-safe tools, unified streaming, and multi-agent handoffs — across Claude Code, ChatGPT Codex, and Kimi-CLI.
